...
Var
  Nome: string;   //Ctrl shift G forma uma váriavel em cima
           //RadioButton = seleção - ativa um e desativa o outro
begin      //RodioButton = parente da listboss = itens = cria os botões automático
   Nome:=edtNome.Text;
